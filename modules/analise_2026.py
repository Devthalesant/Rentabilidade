...
def carregar_custo_fixo():
    return pegar_dados_mongodb("rentabilidade_anual", "custos_fixos_2026")

@st.cache_data(ttl=3600)
def carregar_vmb():
    return pegar_dados_mongodb("rentabilidade_anual", "venda_mensal_bruta_2026")

@st.cache_data(ttl=3600)
def carregar_taxas():
    return pegar_dados_mongodb("rentabilidade_anual", "impostos_taxas_2026")




def page_analyse_2026():
        # Carrega o df
        ...
        st.title("🌟 Análise de Rentabilidade 2026")
